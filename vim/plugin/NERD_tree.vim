...
call s:initVariable("g:NERDTreeMapJumpFirstChild", "S")
call s:initVariable("g:NERDTreeMapJumpLastChild", "T")
call s:initVariable("g:NERDTreeMapJumpNextSibling", "<C-s>")
call s:initVariable("g:NERDTreeMapJumpParent", "p")
call s:initVariable("g:NERDTreeMapJumpPrevSibling", "<C-t>")
...
call s:initVariable("g:NERDTreeMapOpenVSplit", "k")
