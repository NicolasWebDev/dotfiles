...
call matchadd('ProtelDone', '^\$\d\{2}:\d\{2}_protel\$$')

highlight Protel ctermfg=red cterm=bold
call matchadd('Protel', '^\$\d\{2}:\d\{2}_protel$')

highlight SelectaDone ctermfg=green cterm=underline,bold
call matchadd('SelectaDone', '^\$\d\{2}:\d\{2}_selecta\$$')

highlight Selecta ctermfg=green cterm=bold
call matchadd('Selecta', '^\$\d\{2}:\d\{2}_selecta$')
