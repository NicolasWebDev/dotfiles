...
-- https://awesomewm.org/wiki/Gigamo_Battery_Widget
...
-- https://awesomewm.org/wiki/Rman%27s_Simple_Volume_Widget
local alsawidget =
{
	channel = "Master",
	step = "5%",
...
awful.rules.rules = {
    ...
    { rule = { class = "Whatsie" }, properties = { tag = tags[1][8] } },
    ...
    { rule = { class = "Pdfpc", role = "presentation" },
      properties = {opacity = 1 }, callback = function(c) 
          --awful.client.movetoscreen
          awful.client.movetotag(tags[1][9], c)
          awful.client.movetoscreen(c) end},

    --presenter console 
    { rule = { class = "Pdfpc", role = "presenter" },
